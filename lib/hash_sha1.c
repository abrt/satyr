...
static void common64_hash(btp_sha1_ctx_t *ctx, const void *buffer, size_t len);
static void common64_end(btp_sha1_ctx_t *ctx, int swap_needed);

/* sha1 specific code */

static void sha1_process_block64(btp_sha1_ctx_t *ctx)
{
