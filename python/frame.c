...
static PyMethodDef FrameMethods[] = {
    /* getters & setters */
    { "get_function_name",         p_btp_gdb_frame_get_function_name,         METH_NOARGS,  f_get_function_name_doc         },
    { "set_function_name",         p_btp_gdb_frame_set_function_name,         METH_VARARGS, f_set_function_name_doc         },
    { "get_function_type",         p_btp_gdb_frame_get_function_type,         METH_NOARGS,  f_get_function_type_doc         },
    { "set_function_type",         p_btp_gdb_frame_set_function_type,         METH_VARARGS, f_set_function_type_doc         },
    { "get_number",                p_btp_gdb_frame_get_number,                METH_NOARGS,  f_get_number_doc                },
    { "set_number",                p_btp_gdb_frame_set_number,                METH_VARARGS, f_set_number_doc                },
    { "get_source_file",           p_btp_gdb_frame_get_source_file,           METH_NOARGS,  f_get_source_file_doc           },
    { "set_source_file",           p_btp_gdb_frame_set_source_file,           METH_VARARGS, f_set_source_file_doc           },
    { "get_source_line",           p_btp_gdb_frame_get_source_line,           METH_NOARGS,  f_get_source_line_doc           },
    { "set_source_line",           p_btp_gdb_frame_set_source_line,           METH_VARARGS, f_set_source_line_doc           },
    { "get_signal_handler_called", p_btp_gdb_frame_get_signal_handler_called, METH_NOARGS,  f_get_signal_handler_called_doc },
    { "set_signal_handler_called", p_btp_gdb_frame_set_signal_handler_called, METH_VARARGS, f_set_signal_handler_called_doc },
    { "get_address",               p_btp_gdb_frame_get_address,               METH_NOARGS,  f_get_address_doc               },
    { "set_address",               p_btp_gdb_frame_set_address,               METH_VARARGS, f_set_address_doc               },
    { "get_library_name",          p_btp_gdb_frame_get_library_name,          METH_NOARGS,  f_get_library_name_doc          },
    { "set_library_name",          p_btp_gdb_frame_set_library_name,          METH_VARARGS, f_set_library_name_doc          },
    /* methods */
    { "dup",                       p_btp_gdb_frame_dup,                       METH_NOARGS,  f_dup_doc                       },
    { "cmp",                       p_btp_gdb_frame_cmp,                       METH_VARARGS, f_cmp_doc                       },
    { "calls_func",                p_btp_gdb_frame_calls_func,                METH_VARARGS, f_calls_func_doc                },
    { "calls_func_in_file",        p_btp_gdb_frame_calls_func_in_file,        METH_VARARGS, f_calls_func_in_file_doc        },
    { NULL },
};
...
PyTypeObject FrameTypeObject = {
    ...
    0,                          /* tp_itemsize */
    p_btp_gdb_frame_free,       /* tp_dealloc */
    NULL,                       /* tp_print */
    NULL,                       /* tp_getattr */
    NULL,                       /* tp_setattr */
    NULL,                       /* tp_compare */
...
PyObject *p_btp_gdb_frame_set_function_name(PyObject *self, PyObject *args)
{
    ...
    struct btp_gdb_frame *frame = ((FrameObject *)self)->frame;
...
PyObject *p_btp_gdb_frame_cmp(PyObject *self, PyObject *args)
{
    ...
    struct btp_gdb_frame *f1 = ((FrameObject *)self)->frame;
    struct btp_gdb_frame *f2 = ((FrameObject *)compare_to)->frame;
